...
public class Wednesday extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mMessageRecyclerView = (RecyclerView) view.findViewById(R.id.recy_wed);
        mProgressBar = (ProgressBar)view. findViewById(R.id.progressbarwed);
        ...
        mFirebaseAdapter=new FirebaseRecyclerAdapter<classs, Holder>(classs.class,
                R.layout.card,
                Holder.class,
                mFirebaseDatabaseReference.child("Wednesday")) {
