...
public class Tuesday extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mMessageRecyclerView = (RecyclerView) view.findViewById(R.id.recy_tue);
        mProgressBar = (ProgressBar)view.findViewById(R.id.progressbartue);
        ...
        mFirebaseAdapter=new FirebaseRecyclerAdapter<classs, Holder>(classs.class,
                R.layout.card,
                Holder.class,
                mFirebaseDatabaseReference.child("Tuesday")) {
