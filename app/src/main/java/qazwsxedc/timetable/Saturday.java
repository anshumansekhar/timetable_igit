...
public class Saturday extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.fragement_saturday,container,false);
        mMessageRecyclerView = (RecyclerView) view.findViewById(R.id.recy_sat);
        mProgressBar = (ProgressBar)view. findViewById(R.id.progressbarsat);
        ...
        mFirebaseAdapter=new FirebaseRecyclerAdapter<classs, Holder>(classs.class,
                R.layout.card,
                Holder.class,
                mFirebaseDatabaseReference.child("Saturday")) {
