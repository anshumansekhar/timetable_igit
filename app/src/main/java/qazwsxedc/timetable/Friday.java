...
public class Friday extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mMessageRecyclerView = (RecyclerView) view.findViewById(R.id.recy_fri);
        mProgressBar = (ProgressBar)view. findViewById(R.id.progressbarfri);
        ...
        mFirebaseAdapter=new FirebaseRecyclerAdapter<classs, Holder>(classs.class,
                R.layout.card,
                Holder.class,
                mFirebaseDatabaseReference.child("Friday")) {
